...
`;
  ...
  11.1 COPPA. Our Service is not directed to children who are under the age of 13 in compliance with the U.S. Children’s Online Privacy Protection Act (COPPA). We do not knowingly collect Personal Information from children under the age of 13. If you have reason to believe that a child under the age of 13 has provided Personal Information to us, please contact BootcampsHub as provided in the “Contact Us” section below. We will investigate any notification and if appropriate, delete the Personal Information from our systems. If you are 13 or older but under 18, you must have consent from your parent or guardian to use our Services.
...
`;
  ...
  12.4. You can object to further marketing at any time by selecting the “unsubscribe” link at the end of all our marketing and promotional update communications to you or by sending us an email to [support@bootcampshub.ai](support@bootcampshub.ai).
`;
  ...
  15.6 Non-Discrimination. If you elect to exercise any of your rights under CCPA/CPRA, BootcampsHub will not discriminate against you for exercising any of your CCPA/CPRA rights. Unless otherwise permitted by the CCPA/CPRA, we will not deny you goods or services, charge you a different price or rate for our goods or services, or provide you a different level or quality of goods or services because you exercised such rights. Under the current definition of CCPA/CPRA, BootcampsHub does not sell your Personal Information.
  `;
...
Email: [support@bootcampshub.ai](support@bootcampshub.ai)
  `;
  ...
  const data = [
    ...
    {
      purpose:
        'Business and legal operations, for example, to assess your suitability for a role at BootcampsHub and invite you to interview',
      basis:
  ...
  return (
    <ScrollView
      ...
      <Text style={styles.normalText}>
        "BootcampsHub" is a white-label platform designed to provide
        comprehensive school solutions. White-label platforms typically offer
        customizable software or services that businesses can brand and use as
        their own. In the context of schools, a white-label platform like
        "BootcampsHub" might offer various features and functionalities to help
        schools automate their processes and enhance the learning experience for
        students.
      </Text>
      <SectionHeading
        heading={
      ...
      />
      <Markdown style={styles.markdownStyle}>{markdownContent1}</Markdown>
      <Text style={styles.normalText}>
      ...
      <Markdown style={styles.markdownStyle}>{markdownContent2}</Markdown>

      <SectionHeading heading={'2. Data Controller'} />
      <Markdown style={styles.markdownStyle}>{markdownContent3}</Markdown>
      <SectionHeading heading={'3. Types of Information We Collect.'} />
      <Markdown style={styles.markdownStyle}>{markdownContent4}</Markdown>
      <SectionHeading heading={'4. Cookies.'} />
      <Markdown style={styles.markdownStyle}>{markdownContent5}</Markdown>
      <View style={{height: 20}}></View>
      <SectionHeading heading={'Cookie-List'} />
      <Markdown style={styles.markdownStyle}>{markdownContent6}</Markdown>
      <SectionHeading heading={'Performance Cookies'} />
      <Markdown style={styles.markdownStyle}>{markdownContent7}</Markdown>
      <SectionHeading heading={'Functional Cookies'} />
      <Markdown style={styles.markdownStyle}>{markdownContent8}</Markdown>
      <SectionHeading
      ...
      <Markdown style={styles.markdownStyle}>{markdownContent9}</Markdown>
      <SectionHeading heading={'7. Consent.'} />
      <Markdown style={styles.markdownStyle}>{markdownContent10}</Markdown>
      <SectionHeading heading={'8. Security of your Personal Data.'} />
      <Markdown style={styles.markdownStyle}>{markdownContent11}</Markdown>
      <SectionHeading heading={'9. International Transfers.'} />
      <Markdown style={styles.markdownStyle}>{markdownContent12}</Markdown>
      <SectionHeading
        heading={'10. Will we share your information with anyone else?'}
      />
      <Markdown style={styles.markdownStyle}>{markdownContent13}</Markdown>
      <SectionHeading heading={'11. Minor’s Privacy.'} />
      <Markdown style={styles.markdownStyle}>{markdownContent14}</Markdown>
      <SectionHeading heading={'12. Marketing.'} />
      <Markdown style={styles.markdownStyle}>{markdownContent15}</Markdown>
      <SectionHeading heading={'13. Sale of Business.'} />
      <Markdown style={styles.markdownStyle}>{markdownContent16}</Markdown>
      <SectionHeading heading={'14. Your Personal Information Rights.'} />
      <Markdown style={styles.markdownStyle}>{markdownContent17}</Markdown>
      <SectionHeading heading={'15. California Privacy Rights.'} />
      <Markdown style={styles.markdownStyle}>{markdownContent18}</Markdown>
      <SectionHeading heading={'16. California Minors.'} />
      <Markdown style={styles.markdownStyle}>{markdownContent19}</Markdown>
      <SectionHeading
        heading={
          '17. Privacy Notice to Residents of Colorado, Connecticut, Virginia, and Utah.'
        }
      />
      <Markdown style={styles.markdownStyle}>{markdownContent20}</Markdown>
      <SectionHeading heading={'18. Privacy Notice for Residents of Nevada.'} />
      <Markdown style={styles.markdownStyle}>{markdownContent21}</Markdown>
      <SectionHeading
        heading={'19. Requests by Data Subjects to exercise their rights.'}
      />
      <Markdown style={styles.markdownStyle}>{markdownContent22}</Markdown>
      <SectionHeading
        heading={'20. Contact Us.'}
        text={'Our data protection manager can be contacted as follows:'}
      />
      <Markdown style={styles.markdownStyle}>{markdownContent23}</Markdown>
      <SectionHeading heading={'21. Changes to the Privacy Policy.'} />
      <Markdown style={styles.markdownStyle}>{markdownContent24}</Markdown>
      <SectionHeading heading={'22. Annex 1 - California Privacy Rights.'} />
      <Markdown style={styles.markdownStyle}>{markdownContent25}</Markdown>
