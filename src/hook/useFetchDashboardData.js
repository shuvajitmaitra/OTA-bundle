  ...
  useEffect(() => {
    ...
    axiosInstance
      ...
      .then((res) => {
        ...
        const { colorMap, labelMap } = generateDynamicMappings(results);
        const transformedData = transformData(results, colorMap, labelMap);
        dispatch(setProgressData(transformedData));
