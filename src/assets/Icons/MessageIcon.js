...
const MessageIcon = ({ color }) => {
  ...
  return (
    <Svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} fill="none">
      <G stroke={color || Colors.BodyText} strokeLinecap="round" strokeLinejoin="round" clipPath="url(#a)">
        <Path
          strokeMiterlimit={10}
          strokeWidth={1.5}
        ...
        />
        <Path strokeWidth={2} d="M13.328 9.167h.008m-3.343 0h.009m-3.342 0h.007" />
      </G>
      <Defs>
        <ClipPath id="a">
