...
const AssessmentRulesModal = ({ toggleModal, isModalVisible, toggleStartTestModal }) => {
  // --------------------------
  // ----------- Import theme Colors -----------
  // --------------------------
      ...
      <View style={styles.modalContainer}>
        ...
        <View style={styles.modalBody}>
          ...
          <View style={styles.rulesContainer}>
            ...
            <Text style={styles.rulesText}>2. You will get 10 minutes for 10 question</Text>
            <Text style={styles.rulesText}>3. You can’t leave while answering.</Text>
            <Text style={styles.rulesText}>
              4. You will <Text style={{ color: Colors.Primary }}>Get discount </Text> according to your mark
            </Text>
          </View>
