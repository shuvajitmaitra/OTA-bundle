...
function CongratulationModal({ congratulationModalVisible, setCongratulationModalVisible }) {
    ...
    <Modal isVisible={congratulationModalVisible}>
      <View style={styles.modalContainer}>
        <View style={styles.modalTop}>
          <TouchableOpacity onPress={() => setCongratulationModalVisible(false)}>
            <CloseIcon />
          </TouchableOpacity>
        </View>
        ...
        <View>
          <View style={styles.bgImgContainer}>
            <Image source={{ uri: "https://shorturl.at/jnMUZ" }} style={styles.bgImg} />
            <Text style={styles.modalHeading}>Congratulations!</Text>
          </View>
          <Text style={styles.modalSubHeading}>You have submitted the text successfully</Text>
