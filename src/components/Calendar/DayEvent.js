  ...
  return (
    <View style={styles.container}>
      ...
      <EventDetailsModal
        ...
        toggleEventDetailsModal={() => setIsEventDetailsModalVisible(!isEventDetailsModalVisible)}
        eventId={eventId}
      />
      <UpdateEventModal eventId={eventId} modalVisible={isUpdateModalVisible} setModalVisible={setIsUpdateModalVisible} />
    </View>
  );
};
