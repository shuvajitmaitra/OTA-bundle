...
const GlobalAlertModal = () => {
  ...
  useEffect(() => {
    if (alert.visible) {
      ...
      // Clean up the timer when the component unmounts or if the alert visibility changes
  ...
  return (
    <Modal
      ...
      <View style={styles.alertBox}>
        ...
        <Text style={styles.heading}>{alert?.data?.title || 'Success'}</Text>
