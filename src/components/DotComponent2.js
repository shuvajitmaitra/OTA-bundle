...
import { setMonthViewData, updateCalendar } from "../store/reducer/calendarReducer";
...
const DotComponent2 = () => {
  ...
  return (
    <View style={styles.dotContainer}>
      <TouchableOpacity onPress={() => handleButtonPress("accepted")} style={styles.dot}>
      ...
      <TouchableOpacity onPress={() => handleButtonPress("myEvents")} style={styles.dot}>
      ...
      <TouchableOpacity onPress={() => handleButtonPress("pending")} style={styles.dot}>
      ...
      <TouchableOpacity onPress={() => handleButtonPress("denied")} style={styles.dot}>
        <RedDotSvgComponent />
        <Text
          style={[
            styles.text,
      ...
      <TouchableOpacity onPress={() => handleButtonPress("proposedNewTime")} style={styles.dot}>
        <BlueDotSvgComponent />
        <Text
          style={[
            styles.text,
