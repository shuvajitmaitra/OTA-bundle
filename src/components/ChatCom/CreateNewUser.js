  ...
  return (
    <View style={[styles.container, { paddingTop: top }]}>
      ...
      <FlatList
        ...
        ItemSeparatorComponent={() => <Divider marginTop={0.000001} marginBottom={0.00001} />}
        ListEmptyComponent={() => (
          <View style={{ height: responsiveScreenHeight(80), justifyContent: "center", alignItems: "center" }}>
            <NoDataAvailable />
          </View>
        )}
      />
