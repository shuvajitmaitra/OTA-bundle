...
export default function ProgramPriority({ onPriorityChange }) {
      ...
      <View style={styles.container}>
        <TouchableOpacity onPress={() => handlePriorityChange("high")}>
          <View style={styles.priorityContainer}>
            ...
            <Text style={[styles.highText, selectedPriority === "high" && styles.selectedText]}>- High Priority</Text>
          </View>
        </TouchableOpacity>
        ...
        <TouchableOpacity onPress={() => handlePriorityChange("medium")}>
          <View style={styles.priorityContainer}>
            ...
            <Text style={[styles.mediumText, selectedPriority === "medium" && styles.selectedText]}>- Medium Priority</Text>
          </View>
        </TouchableOpacity>
        ...
        <TouchableOpacity onPress={() => handlePriorityChange("low")}>
          <View style={styles.priorityContainer}>
            ...
            <Text style={[styles.lowText, selectedPriority === "low" && styles.selectedText]}>- Low Priority</Text>
          </View>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.container2}>
        <TouchableOpacity onPress={() => handlePriorityChange("pinned")}>
          <View style={styles.priorityContainer}>
            ...
            <Text style={[styles.pinnedText, selectedPriority === "pinned" && styles.selectedText]}>- Pinned</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => handlePriorityChange("completed")}>
          <View style={styles.priorityContainer}>
            <CompleteIcon width={12} height={12} />
            <Text style={[styles.completeText, selectedPriority === "completed" && styles.selectedText]}>- Completed</Text>
          </View>
        </TouchableOpacity>
        ...
        <TouchableOpacity onPress={() => handlePriorityChange("incomplete")}>
          <View style={styles.priorityContainer}>
            ...
            <Text style={[styles.incompleteText, selectedPriority === "incomplete" && styles.selectedText]}>- Incomplete</Text>
          </View>
        </TouchableOpacity>
