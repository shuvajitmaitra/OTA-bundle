...
const SntChart = () => {
  ...
  const showTell = useSelector((state) => state.dashboard?.dashboardData?.showTell?.results);
  ...
  return (
    <View>
      ...
      <View style={styles.legendContainer}>
        <LegendItem color={Colors.Primary} label="Accepted" value={showTell?.acceptedItems} styles={styles} />
        <LegendItem color="#F90" label="Pending" value={showTell?.pendingItems} styles={styles} />
        <LegendItem color="#F34141" label="Rejected" value={showTell?.rejectedItems} styles={styles} />
      </View>
    </View>
  );
};
