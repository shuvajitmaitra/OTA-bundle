  ...
  return (
    <View style={styles.mainContainer}>
      ...
      {isLoading ? (
        ...
        <View>
          <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.tabViewContainer}>
          ...
          {chapters.length > 6 && (
            <TouchableOpacity onPress={handleShowMoreOrLess} style={styles.showMoreButton}>
              <Text style={styles.showMoreButtonText}>{displayCount >= chapters?.length ? "See Less" : "See More"}</Text>
            </TouchableOpacity>
          )}
        </View>
      )}
