    ...
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        <View style={styles.headerLeft}>
          ...
          >
            <ArrowTopRight backgroundColor={Colors.MediumGreen} color={Colors.Primary} />
          </TouchableOpacity>
        </View>
        <Text style={styles.headerText}>
          <Text style={styles.headerBold}>{item?.count}</Text> out of <Text style={styles.headerBold}>{item?.limit}</Text>
        </Text>
      </View>
